...
const Hero = () => {
	...
	return (
		<section
			id='home'
			className='min-h-screen flex items-center justify-center bg-black text-white pt-20'
		>
			<div className='container mx-auto px-4 relative'>
				<div className='grid grid-cols-1 md:grid-cols-12 md:mt-0 -mt-[8rem] gap-8'>
					<motion.div
					...
					>
						<motion.div
							className='w-full flex items-center justify-center mb-8 mt-24 relative z-20'
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
					...
					>
						...
						>
							...
							<div className='relative'>
								...
								<h1 className='text-7xl z-0 md:text-[200px] font-bold tracking-tighter leading-none -mt-4'>
						...
						<motion.p
							className='text-center mt-4 md:w-[150%] w-[80%]'
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
